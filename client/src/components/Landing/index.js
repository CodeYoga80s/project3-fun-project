    ...
    return (
      <div className="App">
        ...
        <div className="jumbotron jumbotron-fluid">
          ...
          <img src={logo} style={{ height: "150px", width: "150px", textAlign: "center" }} className="App-logo" alt="logo"/>

          <h1 style={{ fontsize: 55, clear: "both", textAlign: "center" }} className="display-4">IMBIBE</h1>
